...
public class WheatPennyEntity
	implements CoinInterface {
	
	private static final Double VALUE = new Double(0.01);
	private static final Double DIAMETER_IN_MILLIMETERS = new Double(19);
	private static final Double THICKNESS_IN_MILLIMETERS = new Double(1.55);
	private static final BigDecimal MASS_IN_GRAMS = new BigDecimal("3.11");
